  ...
  datastores: {
    ...
    default: {
      ...
      /****************************************************************************
		...
		// ssl: true,
		adapter: 'sails-mongo',
		  url: 'mongodb://dvs_cuong:Abc.123@14.161.1.28:27017/GasTracking'
		//   url: 'mongodb://localhost:27017/GasTracking'
		// url: 'mongodb://localhost:27017/GasTracking_GasSouth'
    },
    ...
    /***************************************************************************
		 ...
		 ***************************************************************************/
         cors: {
            ...
            //allowOrigins: ['https://4te.vn', 'http://4te.vn'],
			//allowCredentials: false,

			// allowOrigins: [
			// 	'https://4te.vn', 'http://4te.vn',
			// 	'https://truyxuat.pgs.com.vn', 'http://truyxuat.pgs.com.vn',
			// 	'https://pgs.com.vn', 'http://pgs.com.vn'],			
			// allowCredentials: false,
			
			allowOrigins: ['https://4te.crmdvs.vn', 'http://4te.crmdvs.vn', 'http://localhost:8080'],
